...
The plugin adds the following properties to the component element's data:
...
The `trigger` function is used to load the component. The trigger option specifies when and how this function should be called.

### Component content

The `x-remote-component` element can contain any content that will be visible until it is replaced with the component. This content can be used for placeholders, loading indicators, progress bars, or buttons that trigger the component, etc.
...
The contents of these elements replace the corresponding `data-slot` elements in the component. This provides functionality similar to slots and improves component reusuability. 
